...
`,floraVertShader=`
  ...
  void main() {
    ...
    // Wind sway - gentle, from top of each blade
    ...
    float combinedWind = (noise1 * 0.7 + noise2 * 0.3) * uWindStrength;
    float windFactor = pow(uv.y, 2.0) * combinedWind * 0.4;
    transformed.x += windFactor;
    transformed.z += windFactor * 0.2;
